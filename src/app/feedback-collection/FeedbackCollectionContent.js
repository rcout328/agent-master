...
export default function FeedbackCollectionContent() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <h2 className="text-2xl font-bold text-purple-400 mb-4">Feedback Collection</h2>
        <p className="text-gray-300">
          View and analyze collected feedback snapshots from your research.
        </p>
      </div>
      ...
      {storedSnapshots.length === 0 && (
        <div className="text-center py-12">
          <p className="text-gray-400 mb-4">No feedback snapshots found.</p>
          <Link 
